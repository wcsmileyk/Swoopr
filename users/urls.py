...
urlpatterns = [
    ...
    path('swooper/', views.swooper_dashboard_view, name='swooper_dashboard'),
    ...
    path('flight/<int:flight_id>/toggle-swoop-rejected/', views.toggle_swoop_rejected_view, name='toggle_swoop_rejected'),
    ...
    path('gate/upload/', views.upload_gate_file, name='upload_gate_file'),
